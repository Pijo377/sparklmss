...
const FileDetailsCard: React.FC<FileDetailsCardProps> = ({
    ...
    return (
        <Card className="p-6 flex-1 flex flex-col border-blue-200 border-2 shadow-sm">
            <div className="flex items-center gap-3 mb-4 border-b border-blue-50 pb-2">
                <FileText size={16} className="text-blue-600" />
                <h3 className="text-sm font-semibold text-blue-600 ">File Details</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                <div>
                    <label className="block text-sm font-medium text-slate-400 mb-1.5">ACH Provider</label>
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-400 mb-1.5">ACH Task Name</label>
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-400 mb-1.5">Returns Task Name</label>
