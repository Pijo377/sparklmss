    ...
    return (
        <Card className="p-5 border-purple-400 border-2 shadow-sm">
            ...
            <div className={`grid grid-cols-1 ${selectedFileType === 'CSV File' ? 'md:grid-cols-2' : 'md:grid-cols-3 lg:grid-cols-4'} gap-x-6 gap-y-4`}>
                <div>
                    <label className="block text-sm font-medium text-slate-900 mb-1.5">{selectedFileType === 'CSV File' ? 'CSV Group Name' : 'ACH Group Name'}</label>
                ...
                {selectedFileType !== 'CSV File' && (
                    <>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-900 mb-1.5">Immediate Origin</label>
                        ...
                        <div>
                            ...
                            </TooltipProvider> <Input className="h-11 px-4 text-sm bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" type="text" maxLength={23} value={destinationName} onChange={(e) => setDestinationName(e.target.value)} />
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-900 mb-1.5">Company ID</label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-900 mb-1.5">ACH File Extension</label>
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-900 mb-1.5">Return File Type</label>
